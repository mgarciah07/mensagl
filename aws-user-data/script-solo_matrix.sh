...
DOMINIO="https://marcosmatrix.duckdns.org"

read -p "Por favor, introduce la contrasena del usuario de la base de datos synapse_user:" CONTRASENA

# IP privada del servidor postgresql
SERVIDOR="10.210.3.100,10.210.3.101"
