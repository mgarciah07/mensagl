...
# Certificate is saved at: /etc/letsencrypt/live/marcosticket.duckdns.org/fullchain.pem
# Key is saved at:         /etc/letsencrypt/live/marcosticket.duckdns.org/privkey.pem
...
cat /etc/letsencrypt/live/marcosticket.duckdns.org/fullchain.pem /etc/letsencrypt/live/marcosticket.duckdns.org/privkey.pem | sudo tee /etc/letsencrypt/live/marcosticket.duckdns.org/haproxy.pem
